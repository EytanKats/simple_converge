...
class ResNet50(BaseModel):
    ...
    def __init__(self):
        ...
        # Skip connections for TF 1.13.1 versions
        # self.skip_connections = {
        #     2: "activation",
        #     4: "activation_9",
        #     8: "activation_21",
    ...
    def parse_args(self, **kwargs):
        ...
        super(ResNet50, self).parse_args(**kwargs)
    ...
    def get_backbone(self):
        ...
        """
        This method returns ResNet50 model without top as defined in tensorflow.keras
        :return: ResNet50 model without top as defined in tensorflow.keras
        """
    ...
    def build(self):
        ...
        """
        This method builds architecture of ResNet50 model including top as defined in tensorflow.keras
        :return: None
        """
        ...
        if self.classes_num != 1000 and self.tensorflow_weights == "imagenet":  # in this case we need to add custom top
            ...
            model = tf.keras.applications.ResNet50(weights=self.tensorflow_weights,
