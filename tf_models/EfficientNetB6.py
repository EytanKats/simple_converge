...
class EfficientNetB6(BaseModel):
    
    """
    This class encapsulates EfficientNetB6 model
    """
    ...
    def parse_args(self, **kwargs):
        ...
        super(EfficientNetB6, self).parse_args(**kwargs)
    ...
    def get_backbone(self):
        ...
        """
        This method returns EfficientNetB6 model without top as defined in efficientnet package
        :return: EfficientNetB6 model without top as defined in efficientnet package
        """

        backbone = efn.EfficientNetB6(include_top=False,
    ...
    def build(self):
        ...
        """
        This method builds architecture of EfficientNetB6 model including top as defined in efficientnet package
        :return: None
        """
        ...
        if self.classes_num != 1000 and self.tensorflow_weights == "imagenet":  # in this case we need to add custom top
            ...
            model = efn.EfficientNetB6(weights=self.tensorflow_weights,
