...
class ResNet101(BaseModel):
    ...
    """
    This class encapsulates ResNet101 model
    """
    ...
    def parse_args(self, **kwargs):
        ...
        super(ResNet101, self).parse_args(**kwargs)
    ...
    def get_backbone(self):
        ...
        """
        This method returns ResNet101 model without top as defined in tensorflow.keras
        :return: ResNet101 model without top as defined in tensorflow.keras
        """

        backbone = tf.keras.applications.ResNet101(include_top=False,
    ...
    def build(self):
        ...
        """
        This method builds architecture of ResNet101 model including top as defined in tensorflow.keras
        :return: None
        """
        ...
        if self.classes_num != 1000 and self.tensorflow_weights == "imagenet":  # in this case we need to add custom top
            ...
            model = tf.keras.applications.ResNet101(weights=self.tensorflow_weights,
