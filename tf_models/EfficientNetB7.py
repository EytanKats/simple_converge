...
class EfficientNetB7(BaseModel):
    ...
    """
    This class encapsulates EfficientNetB7 model
    """
    ...
    def parse_args(self, **kwargs):
        ...
        super(EfficientNetB7, self).parse_args(**kwargs)
    ...
    def get_backbone(self):
        ...
        """
        This method returns EfficientNetB7 model without top as defined in efficientnet package
        :return: EfficientNetB7 model without top as defined in efficientnet package
        """

        backbone = efn.EfficientNetB7(include_top=False,
    ...
    def build(self):
        ...
        """
        This method builds architecture of EfficientNetB7 model including top as defined in efficientnet package
        :return: None
        """
        ...
        if self.classes_num != 1000 and self.tensorflow_weights == "imagenet":  # in this case we need to add custom top
            ...
            model = efn.EfficientNetB7(weights=self.tensorflow_weights,
